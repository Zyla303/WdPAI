...
<div class="container-fluid">
      <div class="row">
          ...
          <div class="col-sm-1 mt-18 mr-24">
            <a class="login-button none" href="">
...
<div class="container-fluid">
    <div class="row" id="navig-mobile">
        ...
        <div class="col-sm-1 navig"><a href="seeUser?user=<?php echo $_SESSION['user']; ?>">Change settings</a></div>
          <div class="col-sm-1 navig"><a href="underconstruction">Favourites</a></div> <!--favuser-->
          <div class="col-sm-1 navig"><a href="showWaitOrdersUser?userid=<?php echo $_SESSION['user']?>">Waiting orders</a></div>
          <div class="col-sm-1 navig"><a href="historyuser?userid=<?php echo $_SESSION['user']?>">History</a></div>
          <div class="col-sm-1 navig"><a href="logout">Log Out</a></div>
          <div class="col-sm-2"></div>
     </div>
</div>
</nav>
